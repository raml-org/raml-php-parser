...
RAML;
    ...
    {
        $this->setExpectedException('\Raml\Exception\ValidationException', 'Expected date-only');
    ...
    {
        $this->setExpectedException('\Raml\Exception\ValidationException', 'Expected datetime-only');
    ...
    {
        $this->setExpectedException('\Raml\Exception\ValidationException', 'Expected time-only');
    ...
    {
        $this->setExpectedException('\Raml\Exception\ValidationException', 'Expected datetime');
    ...
    {
        $this->setExpectedException('\Raml\Exception\ValidationException', 'Expected datetime with format Y-m-d H:i:s');
